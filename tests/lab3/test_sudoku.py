...
class TestSudoku(unittest.TestCase):
    ...
    def test_solve(self):
        grid1 = read_sudoku('src/lab3/puzzle1.txt')
        grid2 = read_sudoku('src/lab3/puzzle2.txt')
        grid3 = read_sudoku('src/lab3/puzzle3.txt')

        self.assertEqual(solve(grid1), [
            ['5', '3', '4', '6', '7', '8', '9', '1', '2'], 
            ['6', '7', '2', '1', '9', '5', '3', '4', '8'], 
            ['1', '9', '8', '3', '4', '2', '5', '6', '7'], 
            ['8', '5', '9', '7', '6', '1', '4', '2', '3'], 
